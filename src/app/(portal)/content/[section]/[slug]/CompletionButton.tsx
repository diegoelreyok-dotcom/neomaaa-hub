...
export default function CompletionButton({ documentPath, lang, isCompleted: initialCompleted }: CompletionButtonProps) {
  ...
  const handleComplete = useCallback(async () => {
    ...
    try {
      ...
      // Reset the "just completed" animation state after a few seconds
      ...
      <div className="mt-10 mb-4">
        ...
        <style jsx>{`
          ...
          .animate-completion-ring {
            animation: completion-ring 0.8s ease-out forwards;
          }
          .animate-completion-check {
            animation: completion-check 0.5s ease-out 0.2s both;
          }
          .animate-completion-text {
            animation: completion-text 0.4s ease-out 0.4s both;
          }
        `}</style>
      </div>
    );
