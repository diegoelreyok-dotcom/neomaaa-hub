...
const labels: Record<Lang, {
  ...
  en: {
    pageTitle: 'Settings',
    pageSubtitle: 'Configure your platform, team, and integrations.',
    ...
    generalDesc: 'Broker corporate data, license, and contact.',
    save: 'Save',
    ...
    teamTitle: 'Team',
    teamDescCount: (n) => `${n} member${n !== 1 ? 's' : ''} registered on the platform.`,
    invite: 'Invite',
    ...
    admin: 'Admin',
    rolesTitle: 'Roles',
    rolesDescCount: (n) => `${n} role${n !== 1 ? 's' : ''} configured with section-level permissions.`,
    ...
    contentDescCount: (sec, docs) => `${sec} sections with ${docs} documents total.`,
    languagesTitle: 'Languages',
    languagesDesc: 'Supported languages and translated content status.',
    langSpanish: 'Spanish',
    langRussian: 'Russian',
    documentsLabel: 'documents',
    activeStatus: 'Active',
    securityTitle: 'Security',
    securityDesc: 'Authentication, sessions, and access control.',
    authMethod: 'Authentication Method',
    authValue: 'Login codes (6 digits)',
    sessionDuration: 'Session Duration',
    sessionValue: '30 days',
    adminAccountsTitle: 'Administrator Accounts',
    adminAccountsDesc: 'Users with full access to the admin panel.',
    tableUser: 'User',
    tableLang: 'Language',
    tableStatus: 'Status',
    notFound: 'Not found',
    securityNote: (link) => (<>Access codes are issued when users are created. Use the {link} page to regenerate them.</>),
    usersLinkText: 'Users',
    seedTitle: 'Seed Data',
    seedDesc: 'Re-initialize the system base data.',
    seedRun: 'Run Seed',
    seedRunning: 'Seeding...',
    seedDone: 'Seed complete',
    seedError: 'Seed error',
    integrationsTitle: 'Integrations',
    integrationsDesc: 'Services and APIs connected to the broker ecosystem.',
    statusConnected: 'Connected',
    statusPartial: 'Partial',
    statusPending: 'Pending',
    statusNotConnected: 'Not connected',
    platformTitle: 'Platform',
    platformDesc: 'Technical information about the deploy and repository.',
    platformPortal: 'Portal URL',
    platformGitHub: 'GitHub Repo',
    platformVercel: 'Vercel Dashboard',
    platformVersion: 'Version',
